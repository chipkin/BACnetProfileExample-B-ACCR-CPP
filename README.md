...
[v1.0.0](https://github.com/chipkin/BACnetProfileExample-B-ACCR-CPP/releases/tag/v1.0.0)
(`metrics-windows.json` / `metrics-linux.json`):

<!-- METRICS -->
| Platform | Binary | Size | Start-up to `ready` | Stack commit |
|---|---|---|---|---|
| Windows x64 (windows-2022) | `BACnetExampleBACCR.exe` | 3,251,712 bytes (~3.1 MiB) | 179 ms | `abd4cee1` |
| Linux x64 (ubuntu-latest) | `BACnetExampleBACCR` | 39,944 bytes (~39 KiB) | 109 ms | `abd4cee1` |

v1.0.0 was published from a prebuilt static-library build rather than the
